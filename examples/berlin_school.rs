...
fn main() -> minilogue_xd::Result<()> {
    ...
    let passes: Vec<Pass> = vec![
        ...
        Pass { pattern: &pattern_a, repeats: 4, base_cutoff: 0.30, cutoff_drift: 0.03, vel_scale: 1.0,
               label: "E minor — low register, filter rising" },
        Pass { pattern: &pattern_a, repeats: 4, base_cutoff: 0.42, cutoff_drift: 0.04, vel_scale: 1.0,
               label: "E minor — low, filter opening" },
        Pass { pattern: &pattern_b, repeats: 4, base_cutoff: 0.45, cutoff_drift: 0.03, vel_scale: 1.0,
               label: "E minor — high register enters" },
        Pass { pattern: &pattern_b, repeats: 4, base_cutoff: 0.55, cutoff_drift: 0.05, vel_scale: 1.0,
               label: "E minor — high, filter wide" },
        // Modulate to C minor — darker, deeper
        Pass { pattern: &pattern_a_cm, repeats: 4, base_cutoff: 0.38, cutoff_drift: 0.03, vel_scale: 1.0,
               label: "C minor — the key drops, new territory" },
        Pass { pattern: &pattern_a_cm, repeats: 4, base_cutoff: 0.50, cutoff_drift: 0.04, vel_scale: 1.0,
               label: "C minor — low, filter opening" },
        Pass { pattern: &pattern_b_cm, repeats: 4, base_cutoff: 0.48, cutoff_drift: 0.03, vel_scale: 1.0,
               label: "C minor — high register" },
        Pass { pattern: &pattern_b_cm, repeats: 4, base_cutoff: 0.58, cutoff_drift: 0.05, vel_scale: 1.0,
               label: "C minor — high, filter wide" },
        // Return to E minor — homecoming
        Pass { pattern: &pattern_a, repeats: 4, base_cutoff: 0.50, cutoff_drift: 0.04, vel_scale: 1.0,
               label: "E minor — return, filter bright" },
        Pass { pattern: &pattern_b, repeats: 4, base_cutoff: 0.55, cutoff_drift: 0.03, vel_scale: 1.0,
               label: "E minor — high, triumphant" },
        // Fade: velocity drops across 6 reps while filter closes
        Pass { pattern: &pattern_a, repeats: 2, base_cutoff: 0.45, cutoff_drift: -0.03, vel_scale: 0.85,
               label: "fading — pulling back..." },
        Pass { pattern: &pattern_a, repeats: 2, base_cutoff: 0.38, cutoff_drift: -0.03, vel_scale: 0.65,
               label: "fading — quieter..." },
        Pass { pattern: &pattern_a, repeats: 2, base_cutoff: 0.30, cutoff_drift: -0.03, vel_scale: 0.45,
               label: "fading — distant..." },
        Pass { pattern: &pattern_a, repeats: 2, base_cutoff: 0.22, cutoff_drift: -0.02, vel_scale: 0.25,
