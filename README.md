...
- **[`exit`](crates/minilogue-xd/examples/exit.rs)** — TD "Exit" era two-voice performance: aggressive D minor sequence + atmospheric pad layered via a hybrid patch with full keytrack for timbral separation
